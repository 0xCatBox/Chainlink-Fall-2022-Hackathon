...
const WalletPinComponent = ({ sentence, pinvalue }) => {
    ...
    console.log("WalletPinComponent");
                ...
                <Col>
                    <div style={{ display: "flex", justifyContent: "center", marginTop: "30px", marginBottom: "40px" }}>
                        {pin.map((data, index) => {
                            if (data != '') {
                                return (
                                    <div key={index} style={{ display: "flex", justifyContent: "center", alignItems: "center", width: "50px", height: "50px", backgroundColor: "white", borderRadius: "15px", marginLeft: "5px", marginRight: "5px", boxShadow:"0px 5px 0px #CB9C00" }}>•</div>
                                )
                            }
                            else {
                                return (
                                    <div key={index} style={{ width: "50px", height: "50px", backgroundColor: "white", borderRadius: "15px", marginLeft: "5px", marginRight: "5px", boxShadow:"0px 5px 0px #CB9C00" }}></div>
                                )
                            }
                        })}
                    </div>
